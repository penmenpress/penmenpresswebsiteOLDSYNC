...
<ul class="masthead"><li id="masthead-main" title="Agapetry Creations"><a class="agp-toplink" href="https://agapetry.net"> </a></li></ul>
<div id="wrap" style="height: 100%">

<div class="rc-about-dialog">
<p>
<a title="agape" href="https://en.wikipedia.org/wiki/Agape" target="_blank">a<small><small>&#8226;</small></small>ga<small><small>&#8226;</small></small>p&eacute;</a> (&alpha;&gamma;&alpha;&pi;&eta;): 
...
?>
	<p class="agp-proceed">
	<?php
	printf(__( 'Over that last five years, I&apos;ve discovered that WordPress permissions customization is a complex moving target that&apos;s not well-suited to a purely free+consulting model. To ensure commensurate funding for plugin development, documentation and support, I&apos;ve introduced Press Permit Pro. Your purchase provides access and 12 months of updates to a package of extension plugins which provide these and other features:', 'pp' ), '<a href="https://presspermit.com/pp-rs-feature-grid">', '</a>' ); 
	?>
	</p>
...
<a href="https://presspermit.com"><div class="pp-logo">&nbsp;</div></a>
