<?php
//========================================================================================================================
//==========    Library of WP functions : please read description in the head of `library_standard.php` file.   ==========
//========================================================================================================================
...
if (!class_exists('\\Puvox\\standard_wp_library')) {
  class standard_wp_library extends standard_php_library_  
  {
	...
	public function enable_admin_debug($exit){
		if (WP_DEBUG)
			add_filter('wp_php_error_message', function($message, $error){ return $message. $this->var_dump($error['message']); if($exit) die();} , 10,2);
...
// EXAMPLE USAGE: https://gist.github.com/ttodua/1fb2530e7b3de3cc8a23bbdada2e4730
//============================================================================================

  class wp_plugin extends standard_wp_library
  {
	...
	public function set_plugin_prop($name, $value){
		$this->$name = $value;
	}
	public function set_helper_prop($name, $value, $isHelper=false){
	...
	public function ManagerPageValue() { return $this->static_settings['default_managed'] ; }
	...
	*/
	...
	public function define_option_tabs(){
		...
		$this->options_tabs	= array_merge( 
			['Options'],
			$this->static_settings['display_tabs'] ? $this->static_settings['display_tabs'] : [],
			$this->helpers->notifications_enable_db_logs ? ['Notifications'] : [],
			array_merge(
