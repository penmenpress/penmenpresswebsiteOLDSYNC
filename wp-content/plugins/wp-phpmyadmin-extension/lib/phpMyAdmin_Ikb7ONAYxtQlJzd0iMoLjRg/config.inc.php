...
$cfg['blowfish_secret']					= '~!sC[4w;|4|acloA9]L9-wmJz^+O+quy' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('wordpress') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_Ikb7ONAYxtQlJzd0iMoLjRg/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
