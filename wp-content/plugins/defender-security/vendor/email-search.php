	...
	public function add_receipt() {
		...
		if ( ! filter_var( $email, FILTER_VALIDATE_EMAIL ) ) {
			wp_send_json_error( array(
				'error' => __( "Please, insert a valid email.", "defender-security" )
			) );
		}
		...
		foreach ( $this->settings->{$this->attribute} as $item ) {
			if ( $item['email'] == $email ) {
				wp_send_json_error( array(
					'error' => __( "Recipient already exists.", "defender-security" )
				) );
			}
		}
	...
	public function renderInput() {
		...
		<?php if ( $this->lite == false ): ?>
            <div class="sui-notice sui-notice-warning wd-hide no-receipt-warning">
                <p>
					<?php _e( "You've removed all recipients. If you save without a recipient, we'll automatically turn of reports", "defender-security" ) ?>
                </p>
            </div>
            <div class="sui-recipients">
                ...
                <button id="add-new-receipt" data-a11y-dialog-show="email-search-username-dialog" type="button"
                    ...
                    <i class="sui-icon-plus"
                       aria-hidden="true"></i> <?php _e( "Add Recipient", "defender-security" ) ?>
                </button>
            </div>
                    ...
                    <div class="sui-box" role="document">
                        <div class="sui-box-header">
                            <h3 class="sui-box-title">
								<?php _e( "Add Recipient", "defender-security" ) ?>
                            </h3>
                        ...
                        <div class="sui-box-body">
                            <p>
								<?php _e( "Add as many recipients as you like, they will receive email reports as per the schedule you set.", "defender-security" ) ?>
                            </p>
                        ...
                        <div class="sui-box-footer">
                            ...
                            <button id="add-receipt" type="button"
                                    class="sui-modal-close sui-button"><?php _e( "Add", "defender-security" ) ?></button>
                        </div>
                    </div>
                </div>
            </div>
