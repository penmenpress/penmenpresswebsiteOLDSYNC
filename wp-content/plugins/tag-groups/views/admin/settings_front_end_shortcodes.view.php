<div class="tg_settings_tabs_content">
  ...
  <div class="tg_admin_accordion" >
    ...
    <div>
      ...
      <h4><?php _e( 'Parameters', 'tag-groups' ) ?></h4>
      <p><?php printf( __( 'Please find the parameters in the <a %s>documentation</a>.', 'tag-groups' ), 'href="https://documentation.chattymango.com/documentation/tag-groups-premium/alphabetical-tag-index/alphabetical-tag-index-parameters/?pk_campaign=tg&pk_kwd=documentation" target="_blank"' ) ?></p>
    </div>
