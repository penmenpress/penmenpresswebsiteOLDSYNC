        ...
        if (max_number > 0) {
          for (var key in groups) {
            ...
            if (data_set.id!=null) {
              ...
              output += '<td class="tg_label_column"><span class="tg_edit_label tg_text" data-position="' + position + '" data-label="' + escape_html(data_set.label) + '">' + escape_html(data_set.label) + '\<span class="dashicons dashicons-edit tg_pointer" style="display:none;"></span></span></td>\n';
              ...
              output += '<tr class="tg_new_group_row" style="display:none;" id="tg_new_' + position + '">\n';
              output += '<td style="display:none;">' + labels.newgroup + '</td>\n';
              output += '<td colspan="5" style="display:none;"><input data-position="' + position + '"  placeholder="' + labels.placeholder_new + '">';
