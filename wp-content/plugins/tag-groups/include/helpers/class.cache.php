...
if ( ! class_exists('TagGroups_Cache') ) {
  ...
  class TagGroups_Cache {
    ...
    private $path; // absolute path where to store cache files, if $type == TagGroups_Cache::FILE
    ...
    */
    ...
    public function __construct() {}
      ...
      * @return object $this
      */
      public function type( $type = TagGroups_Cache::WP_OPTIONS ) {

        // check if dpendencies are met
        if ( TagGroups_Cache::WP_OPTIONS == $type && ! function_exists( 'get_option' ) ) {
      ...
      */
      public function get() {
        ...
        switch ( $this->type ) {
          ...
          case TagGroups_Cache::WP_OPTIONS:
      ...
      */
      ...
      ##############################
      #         TagGroups_Cache::WP_OPTIONS
      ##############################

      /**
      * Getter for use with native TagGroups_Cache::WP_OPTIONS - simple but maybe not useful for big amounts of data
      *
      * @param void
      * @return mixed
      */
      ...
      /**
      * Setter for use with native TagGroups_Cache::WP_OPTIONS - simple but maybe not useful for big amounts of data
      *
      * @param mixed $data
      * @return bool success?
      */
      ...
      */
      ...
      ##############################
      #         TagGroups_Cache::FILE
      #
      # file pattern: key as md5, dash, timestamp, dot, php
      ##############################

      /**
      * Getter for use with TagGroups_Cache::FILE
      *
      * @param void
      * @return mixed
      */
      ...
      /**
      * Getter for use with TagGroups_Cache::FILE - simple but maybe not useful for big amounts of data
      *
      * @param mixed $data
      * @return bool success?
      */
