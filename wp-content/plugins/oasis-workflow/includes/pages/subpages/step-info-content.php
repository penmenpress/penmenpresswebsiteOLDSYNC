    ...
    <div id="step-setting-content" style="overflow:auto;">
        ...
        <div>
            <div style="margin-left:0px;">
                <label>
                    ...
                    <a href="#"
                       title="<?php esc_html_e( 'Check this box to assign the task to all the users in this step and hide the assignee list during the sign off process.', "oasisworkflow" ); ?>"
                       class="tooltip"
                    >
                        <span title="">
        ...
        <div class="first-step-post-status owf-hidden">
            <label><?php esc_html_e( 'Post Status (on submit) : ', 'oasisworkflow' ); ?>
                <a href="#" title="<?php esc_html_e( 'Post Status after submit to workflow.', "oasisworkflow" );
				?>" class="tooltip">
                    <span title="">
                        <img src="<?php echo esc_url( OASISWF_URL ) . 'img/help.png'; ?>" class="help-icon"/>
                    </span>
                ...
                <div>
                    ...
                    <div class="left">
                        ...
                        <input type="button" id="addPlaceholderAssignmentSubj" class="button-primary placeholder-add-bt"
                               value="<?php esc_html_e( "Add to subject", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                        <input type="button" id="addPlaceholderAssignmentMsg" class="button-primary placeholder-add-bt"
                               value="<?php esc_html_e( "Add to message", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                    </div>
                    <br class="clear">
                </div>
