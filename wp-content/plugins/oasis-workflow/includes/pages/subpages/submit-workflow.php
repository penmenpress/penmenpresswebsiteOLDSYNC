...
ADD_BLANK_OPTION;
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo esc_html( $due_date_label ) . " : "; ?>
                        <a href="#"
                           title="<?php echo esc_html__( 'Specify a date for the assignment to be completed.', "oasisworkflow" ); ?>"
                           class="tooltip">
                     <span title="">
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo esc_html( $publish_date_label ) . " : "; ?>
                        <a href="#"
                           title="<?php echo esc_html__( 'Specify a desired publish date for the post.', "oasisworkflow" ); ?>"
                           class="tooltip">
                  <span title="">
                     <img src="<?php echo esc_url( OASISWF_URL ) . '/img/help.png'; ?>" class="help-icon"/></span>
                        </a>
    ...
    <div class="select-info left changed-data-set full-width">
        <input type="button" id="submitSave" class="button-primary"
               value="<?php echo esc_html__( "Submit", "oasisworkflow" ); ?>"/>
        <span>&nbsp;</span>
