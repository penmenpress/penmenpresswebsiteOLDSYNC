                    ...
                    <div class="postbox">
                        ...
                        <h3 style="padding:7px;">
                            <span class="process-lbl">
                                ...
                                <a href="#"
                                   title="<?php esc_html_e( 'Drag and Drop the processes into the Workflow Design Canvas to create new workflow steps.', "oasisworkflow" );
                                   ?>" class="tooltip">
                                    <span title="">
                                    ...
                                    <td>
                                        <label>
                                            <span class="space bold-label">
                                                ...
                                                <a href="#"
                                                   title="<?php esc_html_e( 'Specify a date from which this workflow will become available for use.', "oasisworkflow" );
                                                   ?>" class="tooltip">
                                                    <span title="">
                                                        <img
                                    ...
                                    <td>
                                        <label>
                                            <span class="space bold-label">
                                                ...
                                                <a href="#"
                                                   title="<?php esc_html_e( 'End date is not required. If not specified, the workflow is valid for ever.
        ...
        <div class="save-action-div">
			...
			if ( $wf_editable ) {
				if ( current_user_can( 'ow_edit_workflow' ) ) { ?>
                    <input type="button" value="<?php esc_html_e( "Save", "oasisworkflow" ) ?>"
                           class="button-primary workflow-save-button" data-bname="save">
					<?php
				}
				if ( current_user_can( 'ow_create_workflow' ) ) { ?>
                    <input type="button" value="<?php esc_html_e( "Copy" ) ?>"
				...
				if ( current_user_can( 'ow_create_workflow' ) ) { ?>
                    <input type="button" value="<?php esc_html_e( "Save as new version", "oasisworkflow" ) ?>"
