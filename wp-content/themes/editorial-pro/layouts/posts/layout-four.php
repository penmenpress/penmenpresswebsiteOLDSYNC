				...
				<figure>
					<?php  
						if( has_post_thumbnail() ) {
							the_post_thumbnail( 'editorial-single-fullwidth' );
						} else {
							$image_src = editorial_pro_image_fallback( 'editorial-single-fullwidth' );
				...
				<ul class="embed-gallery cS-hidden">
					<?php 
						foreach ( $post_embed_gallery as $key => $value ) {
							...
							$image_path = wp_get_attachment_image_src( $image_id, 'editorial-single-fullwidth', true );
...
<div class="post-content-row-wrapper">
