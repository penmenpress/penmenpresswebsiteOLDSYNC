<?php
/**
 * Define HTML for header layout 2
 *
...
<header id="masthead" class="site-header header-layout-2" role="banner">
		
	<?php do_action( 'editorial_pro_top_header' ); ?>

	<div class="logo-ads-wrapper clearfix">
		<div class="mt-container">
			<div id="mt-menu-wrap" class="header2-menu-wrapper clearfix">
