jQuery(document).ready(function($){
   ...
   function editorial_add_file(event, selector) {
      ...
      if ( editorial_upload ) {
         ...
         editorial_upload.on( 'select', function() {
            ...
            editorial_selector.find('.wid-upload-button').unbind().addClass('wid-remove-file').removeClass('wid-upload-button').val(editorial_pro_l10n.remove);
   ...
   function editorial_remove_file(selector) {
      ...
      selector.find('.wid-remove-file').unbind().addClass('wid-upload-button').removeClass('wid-remove-file').val(editorial_pro_l10n.upload);
