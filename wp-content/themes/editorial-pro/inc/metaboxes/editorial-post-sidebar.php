...
function editorial_pro_sidebar_callback( $post ) {
    ...
    $editorial_pro_page_sidebar_option = array(
        'default-sidebar' => array(
            ...
            'thumbnail' => get_template_directory_uri() . '/inc/admin/assets/images/default-sidebar.png'
        ),
        'left-sidebar' => array(
            'id'        => 'left-sidebar',
            'value'     => 'left_sidebar',
        ...
        'no-sidebar-content-centered' => array(
            ...
            'thumbnail' => get_template_directory_uri() . '/inc/admin/assets/images/no-sidebar-center.png'
        ),
    );
